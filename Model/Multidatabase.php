 ...
 */
	public function __construct($id = false, $table = null, $ds = null) {
		...
		$this->loadModels([
			'Multidatbase' => 'Multidatabases.Multidatabase',
 ...
 */
	public function deleteMultidatabase($data) {
		...
		try {
			...
			$conditions = array($this->MultidatabaseContentTree->alias . '.multidatabase_key' => $data['Multidatabase']['key']);
			if (! $this->MultidatabaseContentTree->deleteAll($conditions, false, false)) {
				throw new InternalErrorException(__d('net_commons', 'Internal Server Error'));
			}
